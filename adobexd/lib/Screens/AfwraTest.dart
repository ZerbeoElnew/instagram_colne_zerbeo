...
class AfwraScreen extends StatefulWidget {
  @override
  _AfwraScreenState createState() => _AfwraScreenState();
}
class _AfwraScreenState extends State<AfwraScreen> {
  ...
  //   final url = Uri.parse('https://instagramspamdetectionwebapi.azurewebsites.net/api/User/login');
